...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jrnzo04.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jrnzo04.containers.anotherwebservice.com/
...
```
git clone git@github.com:danielvmnztr/container-jrnzo04.git
cd container-jrnzo04
```
...
```
docker attach container-jrnzo04
```
